...
<div class="container">
  <div class="header"><a href="#"><img src="" alt="Insert Logo Here" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background-color: #FFFFFF; display: block;" /></a>
    ...
    <!-- end .header --></div>
  <div class="sidebar1">
    <form id="form4" name="form4" method="post" action="cari.php">
    
    <p>
      <label for="cari">cari      </label>
    </p>
      <p>
        <input width= "20" type="text" name="cari" id="kata" />
        <input type="submit" name="cari2" id="cari2" value="Submit" />
      </p>
...
?>
    <table width="618" border="0">
      <tr>
      <td width="32"><?php echo $buff['ID']; ?></strong></td>
      <td width="140"><strong>Nama Toko</strong></td>
        <td width="87"><?php echo $buff['nama_toko']; ?></td>
      <td width="136"><strong>Jam Operasional</strong></td>
        <td width="83"><?php echo $buff['operasional']; ?></td>
        <td width="114"><a href="detailpage.php?no=<?php echo $buff['ID']; ?>">Lihat Selengkapnya</a></td>
      </tr>
      <?php
