...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1>Tambah Toko Buku Baru</h1>

    <form action="tambah2.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
	<table width="438" height="156" border="0">
	  <tr>
	    <td width="152">Nama</td>
	    <td width="31">:</td>
	    <td width="241"><input name="nama" type="text" id="nama" value="" /></td>
	    </tr>
	  <tr>
	    <td>Alamat</td>
	    <td>:</td>
	  ...
	  <tr>
	    ...
	    <td>:</td>
	    <td><input type="text" name="jam" id="jam" /></td>
	    </tr>
	  <tr>
	...
	<p>
      ...
      <p>
  		<label for="gambar3"></label>
        <input type="file" name="gambar3" id="gambar3" />
      <p>
  		<label for="gambar4"></label>
  ...
  <div class="footer">
    <p>&copy; Septa Firmansyah P (5212100055)</p>
    <!-- end .footer --></div>
  <!-- end .container --></div>
</body>
</html>