...
?>
      <tr>
	    ...
	    <td><?php echo $buff['nama_toko']; ?></td>
	    <td><?php echo $buff['alamat']; ?></td>
	    <td><?php echo $buff['telp']; ?></td>
	    <td><?php echo $buff['operasional']; ?></td>
        
	    <td><a href="ubah.php?no=<?php echo $buff['ID']; ?>">Edit</a> | <a href="hapus.php?no=<?php echo $buff['ID']; ?>">Hapus</a></td>
	    </tr>
	  <?php
