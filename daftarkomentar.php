...
<div class="container">
  ...
  <div class="content">
    ...
    <form id="form4" name="form4" method="post" action="">
      ...
      <?php
$id = $_GET['no']; 
$query = "SELECT * FROM `komentar` WHERE `nama_toko` = '$id'";
...
?>
      <table width="200" border="0">
        <tr>
          <td><Strong><?php echo $buff['nama_toko']; ?></Strong></td>
        </tr>
      </table>
<table width="724" height="110" border="0">
  <tr>
      	<td height="20"><strong><?php echo $buff['nama_komentar']; ?></strong></td>
	  </tr>
      <tr>
